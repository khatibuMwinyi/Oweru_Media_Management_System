        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-[#0f172a] rounded-xl p-8 border border-slate-800">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Input label="Subject" name="subject" value={formData.subject} onChange={handleChange} error={errors.subject} required />
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full bg-transparent border rounded-md px-4 py-3 text-white placeholder-slate-500 focus:outline-none resize-none ${
                    errors.message ? "border-red-500 focus:border-red-500" : "border-slate-700 focus:border-blue-600"
                  }`}
          ...
          <div className="bg-[#0f172a] rounded-xl p-8 border border-slate-800 space-y-10">
            ...
            <Info
              ...
              title="Call Us"
              lines={[
                { text: "+255 714 859 934", href: "tel:+255714859934" },
            ...
            <Info
              ...
              title="Email Us"
              lines={[
                { text: "info@oweru.com", href: "mailto:info@oweru.com", highlight: true },
                { text: "director@oweru.com", href: "mailto:director@oweru.com", highlight: true },
              ]}
            />
            <Info
              icon={<Globe />}
              ...
              lines={[
                { text: "www.mjengochallenge.com", href: "https://www.mjengochallenge.com", highlight: true },
                { text: "www.oweru.com", href: "https://www.oweru.com", highlight: true },
              ]}
            />
          </div>
        </div>
    ...
    <div>
      ...
      <input
        ...
        className={`w-full bg-transparent border rounded-md px-4 py-3 text-white placeholder-slate-500 focus:outline-none ${
          error ? "border-red-500 focus:border-red-500" : "border-slate-700 focus:border-blue-600"
        }`}
...
function Info({ icon, title, lines }) {
  return (
    <div className="flex gap-4">
      <div className="w-11 h-11 rounded-md bg-blue-700 flex items-center justify-center text-white flex-shrink-0">
        {icon}
      </div>
      <div>
        ...
        {lines.map((line, i) =>
          line.href ? (
            <a
              ...
              className={`block text-sm transition-colors hover:underline underline-offset-2 ${
                line.highlight
